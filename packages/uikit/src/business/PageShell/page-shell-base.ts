...
export { PageShellBaseBackButton, PageShellBaseBody, PageShellBaseHeader, PageShellBaseRoot, PageShellBaseTitle }

export type {
    PageShellBaseBackButtonProps, PageShellBaseBodyProps, PageShellBaseHeaderProps,
