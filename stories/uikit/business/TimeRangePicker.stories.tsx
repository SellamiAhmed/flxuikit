...
const meta: Meta<typeof TimeRangePicker> = {
  title: 'Business/TimeRangePicker',
...
export const Basic: StoryFn = () => {
  ...
  return (
    <TimeRangePicker
      {...props}
      footer={
        <Typography c="dimmed" px={14} pt={8} pb={6} fz="xs">
...
export const Primary: Story = {
  args: {
    ...
    quickRanges: [5 * 60, 15 * 60, 30 * 60, 60 * 60, 3 * 60 * 60, 6 * 60 * 60, 12 * 60 * 60],
    minDateTime() {
...
export const FutureRelativeRange: Story = {
  args: {
    ...
    quickRanges: [
      { value: 5 * 60, isFuture: true },
      { value: 15 * 60, isFuture: true },
      { value: 30 * 60, isFuture: true }
    ]
  }
}
...
export const Internationalization: Story = {
  args: {
    value: { type: 'relative', value: 30 * 60, isFuture: true },
    quickRanges: [
      { value: 5 * 60, label: '未来 5 分钟', isFuture: true },
      { value: 15 * 60, label: '未来 15 分钟', isFuture: true },
      { value: 30 * 60, label: '未来 30 分钟', isFuture: true }
    ],
